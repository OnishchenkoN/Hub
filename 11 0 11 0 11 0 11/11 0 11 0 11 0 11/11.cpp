...
LRESULT CALLBACK WndProc(HWND hWnd, UINT messg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:                      // ПЕРЕРИСОВКА ОКНА
		...
		r.top = x0-60;                  //левый нижний угол
		r.bottom = 150;                 //правый нижний
		r.right = x0 - a / 2;           //правый верхний
		...
		e.top = x1-60;                  //левый нижний угол
		e.right =  x1 - b / 2;          //правый верхний
		e.bottom = 200;                 //правый нижний
		                                //Заполняем прямоугольник
		...
		w.top = x2-57;                  //левый нижний угол
		w.right =  x2 - c / 2;          //правый верхний
		w.bottom = 250;                 //правый нижний
                                        //Заполняем прямоугольник
